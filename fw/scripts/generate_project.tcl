...
#
# generate_project.tcl: Tcl script for re-creating project 'project-qps-proto-captan'
#
# Generated by Vivado on Tue Jul 29 18:01:14 CDT 2025
...
#
#    "/data/javierc/012_QMS_DAQ/03-QPS-Proto-git/fw/project-qps-proto-captan/project-qps-proto-captan.srcs/utils_1/imports/synth_1/main.dcp"
#
...
#    "/data/javierc/012_QMS_DAQ/03-QPS-Proto-git/fw/srcs/ip/ila_3/ila_3.xci"
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../project-qps-proto-captan/project-qps-proto-captan.srcs/utils_1/imports/synth_1/main.dcp"]"\
  ]
  foreach ifile $files {
 ...
 "[file normalize "$origin_dir/../srcs/ip/ila_3/ila_3.xci"]"\
...
set orig_proj_dir "[file normalize "$origin_dir/../project-qps-proto-captan"]"
...
# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../srcs/ip/ila_3/ila_3.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
...
connect_bd_intf_net -intf_net [get_bd_intf_nets microblaze_0_axi_periph_M00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_ports bd_clk] [get_bd_pins microblaze_0/Clk] [get_bd_pins local_mem/LMB_Clk] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_100M/slowest_sync_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins mdm_0/M_AXI_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins mdm_0/S_AXI_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M03_ACLK]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.980761",
   "Default View_TopLeft":"-380,260",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.7.1 2023-07-26 3bc4126617 VDI=43 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port SPI_0 -pg 1 -lvl 8 -x 2410 -y 390 -defaultsOSRD
preplace port gpio_rtl_0 -pg 1 -lvl 8 -x 2410 -y 230 -defaultsOSRD
preplace port port-id_bd_clk -pg 1 -lvl 0 -x -40 -y 310 -defaultsOSRD
preplace port port-id_bd_reset -pg 1 -lvl 0 -x -40 -y 390 -defaultsOSRD
preplace inst axi_quad_spi_0 -pg 1 -lvl 6 -x 2050 -y 400 -defaultsOSRD
preplace inst microblaze_0 -pg 1 -lvl 4 -x 1290 -y 560 -defaultsOSRD
preplace inst local_mem -pg 1 -lvl 5 -x 1720 -y 580 -defaultsOSRD
preplace inst microblaze_0_axi_periph -pg 1 -lvl 5 -x 1720 -y 190 -defaultsOSRD
preplace inst rst_clk_wiz_100M -pg 1 -lvl 1 -x 170 -y 410 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 7 -x 2290 -y 480 -defaultsOSRD
preplace inst mdm_0 -pg 1 -lvl 2 -x 560 -y 490 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 6 -x 2050 -y 230 -defaultsOSRD
preplace netloc Net 1 0 7 -20 510 390 370 720 380 1050 380 1570 -30 1910 500 2190J
preplace netloc bd_reset_1 1 0 1 NJ 390
preplace netloc mdm_0_Debug_SYS_Rst 1 0 3 -10 520 400J 380 710
preplace netloc rst_clk_wiz_100M_mb_reset 1 1 4 350J 360 730 370 1030 650 1540J
preplace netloc rst_clk_wiz_100M_peripheral_aresetn 1 1 5 380 350 740J 360 N 360 1550 -20 1920
preplace netloc axi_gpio_0_GPIO 1 6 2 NJ 230 NJ
preplace netloc axi_quad_spi_0_SPI_0 1 6 2 2180 390 NJ
preplace netloc mdm_0_LMB_0 1 2 3 N 470 N 470 1550J
preplace netloc mdm_0_MBDEBUG_0 1 2 2 750 550 N
preplace netloc mdm_0_M_AXI 1 2 3 750J 350 N 350 1560
preplace netloc microblaze_0_DLMB 1 4 1 N 540
preplace netloc microblaze_0_ILMB 1 4 1 N 560
preplace netloc microblaze_0_M_AXI_DP 1 4 1 1530 40n
preplace netloc microblaze_0_axi_periph_M00_AXI 1 5 2 1890 490 2180
preplace netloc microblaze_0_axi_periph_M01_AXI 1 1 5 410 390 NJ 390 1040 400 NJ 400 1870
preplace netloc microblaze_0_axi_periph_M02_AXI 1 5 1 1900 200n
levelinfo -pg 1 -40 170 560 890 1290 1720 2050 2290 2410
pagesize -pg 1 -db -bbox -sgen -180 -90 2530 790
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../project-qps-proto-captan/project-qps-proto-captan.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
