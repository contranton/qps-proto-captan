...
package ads9813_pkg is
  ...
  constant c_data_SpiCommands : t_data_SPI_COMMANDS := (
    ...
    cmd_B1_TEST_PATTERN_SET_1OF4         => (address => x"14", data => x"FFFF"),
    cmd_B1_TEST_PATTERN_SET_2OF4         => (address => x"15", data => x"FFFF"),
    cmd_B1_TEST_PATTERN_SET_3OF4         => (address => x"19", data => x"FFFF"),
    cmd_B1_TEST_PATTERN_SET_4OF4         => (address => x"1A", data => x"FFFF"),
